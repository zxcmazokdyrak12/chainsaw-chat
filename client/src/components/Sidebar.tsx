...
// Interface for individual room data inside the sidebar
...
// Interface for specific theme tokens used by the sidebar
...
interface SidebarProps {
  ...
  T: SidebarThemeTokens
  onJoinRoom: (roomId: string) => void
}

export default function Sidebar({ rooms, currentRoom, theme, T, onJoinRoom }: SidebarProps) {
  return (
